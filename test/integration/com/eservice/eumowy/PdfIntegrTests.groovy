...
class PdfIntegrTests extends ControllerUnitTestMixin {
	...
	static HashMap<String, String[]> generateCommonFields(){
		...
		data.put("reprezentant1", ["Jan Maria Nowak-Zaliwski"] as String[]);
		data.put("reprezentant2", ["Anna Grażyna Prymek Zduńska"] as String[]);
    ...
    void testFormularzPABR() {
        ...
        RepresentativeCommand representativeCommand = mockCommandObject(RepresentativeCommand)
        ...
        BeneficiaryCommand beneficiaryCommand = mockCommandObject(BeneficiaryCommand)
        ...
        data.putAll(new PABRformMapper(processCommand).getDataForMapping())
