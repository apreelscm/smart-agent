...
class PointData implements Serializable {
	...
	static constraints = {
		...
		nip(nullable:true, blank: false)
		ulica(nullable:true, blank:false)
		nrLokalu(nullable:true, blank:false)
		nrBudynku(nullable:true, blank:false)
		miejscowosc(nullable:true, blank: false)
		kodPocztowy(nullable:true, blank: false)
		poczta(nullable:true, blank:false)
