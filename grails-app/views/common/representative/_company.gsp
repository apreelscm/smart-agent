...
<div class="companyData ${additionalClass}">
    ...
    <div class="phone-container-${prefix}-${seqNo} phone-container-company" style="${data.isPersonForm() && representative?.hasSignedContract != true ? 'display: none;' : ''}">
        <g:radio class="telephone-type" name="${prefix}[${seqNo}].telephoneType${data.isPersonForm() == true ? '-disabled' : ''}" value="${TelephoneType.LANDLINE.name()}"
        ...
        <g:radio class="telephone-type" name="${prefix}[${seqNo}].telephoneType${data.isPersonForm() == true ? '-disabled' : ''}" value="${TelephoneType.MOBILE.name()}"
