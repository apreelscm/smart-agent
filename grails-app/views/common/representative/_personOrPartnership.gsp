...
<div class="personData ${additionalClass}">
    <div class="representativeCBDPersonData" id="representativeCBDPersonData">
        ...
        <div class="address-container address-container-${prefix}-${seqNo} address-container-person"
        ...
        <div class="email-container email-container-${prefix}-${seqNo}" style="${!data.isBusinessLegalFormSelected() || (data.isPersonForm() && representative?.hasSignedContract != true) ? 'display: none;' : ''}">
            <span>
