        ...
        <div style="text-align: center; padding-top: 20px; width: 600px" class="centre">
            ...
            <table style="padding-top: 10px">
                <tr class="vertical-center">
                    <td>&nbsp;</td>
                    <td class="align-right"><g:textField name="paymentForFirstSession" style="width: 100px"/></td>
                    <td class="align-left"><g:message code="panel.for.each.pos"/></td>
                </tr>
                <tr class="vertical-center">
                    <td class="align-right">słownie</td>
                    <td class="align-right"><g:textField name="paymentForFirstSession" style="width: 300px"/></td>
                    <td class="align-left"><g:message code="panel.for.each.pos"/></td>
                </tr>
            </table>
        </div>
