<fieldset class="subpanel-fieldset">
	...
	<div class="subpanel-fieldset-centercontent" >
		<ul class="table-list vertical-center" >
			<li><span class="align-right" ><g:message code="panel.mask" /></span><span><eumowy:textField class="ip" name="${panelType}[${id}].maska" id="${panelType}[${id}].staticDeviceMask" value="${pointData?.maska}"/></span></li>
			<li><span class="align-right" ><g:message code="panel.gateway" /></span><span><eumowy:textField class="ip" name="${panelType}[${id}].bramka" id="${panelType}[${id}].staticDeviceGateway" value="${pointData?.bramka}"/></span></li>
			...
			<li><span class="align-right" ><g:select name="${panelType}[${id}].tytulInformatykStatyczna" from="['', 'Pan','Pani']" valueMessagePrefix="person.title" value="${pointData?.tytulInformatykStatyczna}" /><g:message code="panel.first.name" /></span><span><eumowy:textField name="imieInformatykStatyczna" id="staticDeviceSupportContactName" value="${pointData?.imieInformatykStatyczna}"/></span></li>
