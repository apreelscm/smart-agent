<fieldset class="subpanel-fieldset">
	...
	<div class="subpanel-fieldset-centercontent" >
		<ul class="table-list vertical-center" >
			<li><span class="align-right" ><g:message code="panel.mask" /></span><span><g:textField class="ip" name="${panelType}[${id}].maska" id="${panelType}[${id}].staticDeviceMask" value="${pointData?.maska}"/></span></li>
			...
			<li><span class="align-right" ><g:message code="panel.techniciancontact" /></span><span><g:textField class="mobile-phone" name="${panelType}[${id}].kontaktInformatykStatyczna" id="${panelType}[${id}].staticDeviceSupportContact" value="${pointData?.kontaktInformatykStatyczna}"/></span></li>
...
<fieldset class="subpanel-fieldset">
	...
	<div class="subpanel-fieldset-centercontent" >
		<ul class="table-list vertical-center" >
			<li><span class="align-right" ><g:message code="panel.techniciancontact" /></span><span><g:textField class="mobile-phone" name="${panelType}[${id}].kontaktInformatykDynamiczna" id="${panelType}[${id}].dynamicDeviceSupportContact" value="${pointData?.kontaktInformatykDynamiczna}"/></span></li>
