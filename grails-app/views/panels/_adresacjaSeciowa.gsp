...
<fieldset class="subpanel-fieldset">
	...
	<div class="subpanel-fieldset-centercontent" >
		<ul class="table-list vertical-center" >
			<li><span class="align-right" ><g:message code="panel.techniciancontact" /></span><span><g:textField name="%ID%kontaktInformatykDynamiczna" id="%ID%dynamicDeviceSupportContact" /></span></li>
