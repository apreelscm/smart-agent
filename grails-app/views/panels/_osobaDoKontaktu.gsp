            ...
            <ul class="table-list centre">
                <li class="align-center">
                    <span>
                        ...
                        <span><g:textField name="kontaktImie" value="${data.kontaktImie}" style="width: 120px" maxlength ="15"/></span>
                    </span>
                    <span>
                        <span><g:message code="panel.last.name"/>: </span>
                        <span><g:textField name="kontaktNazwisko" value="${data.kontaktNazwisko}" maxlength ="18"/></span>
                    </span>
                </li>
                <li>
                    <span>
                        <span><g:message code="panel.landline.phone.number"/></span>
                        <span><g:textField class="phone" name="kontaktTelStacjonarny" value="${data.kontaktTelStacjonarny}" style="width: 100px;" maxlength="9"/></span>
                    </span>
                    <span>
