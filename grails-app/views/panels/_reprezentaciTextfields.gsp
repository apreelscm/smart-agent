...
<div>
    ...
    <g:textField name="reprezentant2Imie" value="${data.reprezentant2Imie}" validatable="${data}" maxlength ="13"/>

    <label for="reprezentant2Nazwisko"><g:message code="panel.last.name"/>:</label>
    <g:textField name="reprezentant2Nazwisko" value="${data.reprezentant2Nazwisko}" validatable="${data}" maxlength ="35" class="nazwiskoField"/>
...
<div>
    ...
    <g:textField name="reprezentant3Imie" value="${data.reprezentant3Imie}" validatable="${data}" maxlength ="13"/>

    <label for="reprezentant3Nazwisko"><g:message code="panel.last.name"/>:</label>
    <g:textField name="reprezentant3Nazwisko" value="${data.reprezentant3Nazwisko}" validatable="${data}" maxlength ="35" class="nazwiskoField"/>

    <label for="reprezentant3Stanowisko"><g:message code="panel.position"/>:</label>
    <eumowy:textField name="reprezentant3Stanowisko" value="${data.reprezentant3Stanowisko}" validatable="${data}"/>
</div>