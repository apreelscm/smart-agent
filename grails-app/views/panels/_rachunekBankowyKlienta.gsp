        ...
        <div style="text-align: center; padding-top: 20px; width: 500px" class="centre">
            <ul class="table-list">
                <li>
                    ...
                    <span class="align-left"><eumowy:textField name="numerRachunkuBankowegoKlienta" class="bank-account" value="${data.numerRachunkuBankowegoKlienta}" validatable="${data}" style="width: 250px"/></span>
                </li>
                <li>
