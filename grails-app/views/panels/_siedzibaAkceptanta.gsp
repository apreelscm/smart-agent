        ...
        <div style="text-align: center; padding-top: 20px; width: 750px" class="centre">
            <ul class="table-list centre">
                <li>
                    <span>
                        ...
                        <span>
                            ...
                            <g:textField name="akceptantUlica" value="${data.akceptantUlica}" readonly="${data.isFromCbd('akceptantUlica')}" style="width: 200px" maxlength="19"/>
                            <g:hiddenField name="akceptantUlicaCbd" value="${data.akceptantUlicaCbd}"/>
                        </span>
                        <span>
                            <span>
                                <g:message code="panel.house.number" /></span> <span><g:textField name="akceptantNrDomu" value="${data.akceptantNrDomu}" readonly="${data.isFromCbd('akceptantNrDomu')}" style="width: 50px" maxlength="4"/>
                                <g:hiddenField name="akceptantNrDomuCbd" value="${data.akceptantNrDomuCbd}"/>
                            </span>
                            <span>
                                <g:message code="panel.flat.number" /></span> <span><g:textField name="akceptantNrMieszkania" value="${data.akceptantNrMieszkania}" readonly="${data.isFromCbd('akceptantNrMieszkania')}" style="width: 50px" maxlength="4"/>
                ...
                <li>
                    ...
                    <span>
                        <g:textField name="akceptantMiasto" value="${data.akceptantMiasto}" readonly="${data.isFromCbd('akceptantMiasto')}" style="width: 280px;" maxlength="19"/>
                        <g:hiddenField name="akceptantMiastoCbd" value="${data.akceptantMiastoCbd}"/>
                    </span>
                    <span>
                        <span>
                            <g:message code="panel.postal.code" /></span> <span><g:textField class="postal-code" name="akceptantKodPocztowy" value="${data.akceptantKodPocztowy}" readonly="${data.isFromCbd('akceptantKodPocztowy')}" style="width: 50px" maxlength="5"/>
                ...
                <li>
                    <span>
                        ...
                        <span>
                            <g:textField name="akceptantPoczta" value="${data.akceptantPoczta}" readonly="${data.isFromCbd('akceptantPoczta')}" style="width: 280px;" maxlength="19"/>
                ...
                <li>
                    <span>
                        ...
                        <span>
                            <g:textField class="phone" name="akceptantTelStacjonarny" value="${data.akceptantTelStacjonarny}" readonly="${data.isFromCbd('akceptantTelStacjonarny')}" style="width: 100px;" maxlength="9"/>
                        ...
                        <span>
                            <g:textField class="mobile-phone" name="akceptantTelKomorkowy" value="${data.akceptantTelKomorkowy}" readonly="${data.isFromCbd('akceptantTelKomorkowy')}" style="width: 100px" maxlength="9"/>
