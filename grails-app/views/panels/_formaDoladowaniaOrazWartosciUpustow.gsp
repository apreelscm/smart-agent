    ...
    <fieldset style="text-align: center">
        ...
        <div style="text-align: center; padding-top: 20px; width: 800px" class="centre">
            <table class="vertical-center">
                ...
                <tbody id="ppPayment">
                <g:hiddenField name="pp_orange_tk" value="${data.pp_orange_tk}"/>
                <g:hiddenField name="pp_plus_tk" value="${data.pp_plus_tk}"/>
                <g:hiddenField name="pp_tmobile_tk" value="${data.pp_tmobile_tk}"/>
                <g:hiddenField name="pp_heyah_tk" value="${data.pp_heyah_tk}"/>
                <g:hiddenField name="pp_orange_tp" value="${data.pp_orange_tp}"/>
                <g:hiddenField name="pp_play_tk" value="${data.pp_play_tk}"/>
                <g:hiddenField name="pp_plus_tp" value="${data.pp_plus_tp}"/>
                <g:hiddenField name="pp_telegrosik_tk" value="${data.pp_telegrosik_tk}"/>
                <g:hiddenField name="pp_tmobile_tp" value="${data.pp_tmobile_tp}"/>
                <g:hiddenField name="pp_virginmobile_tk" value="${data.pp_virginmobile_tk}"/>
                <g:hiddenField name="pp_heyah_tp" value="${data.pp_heyah_tp}"/>
                <g:hiddenField name="pp_play_tp" value="${data.pp_play_tp}"/>

                <tr>
                    <td><g:message code="panel.orange"/></td><td><g:message code="panel.ptk.company"/></td>
                    <td> <div class="telekodzikValue">${data.pp_orange_tk}</div> <g:message code="panel.percent"/></td>
                    <td><div class="telepompkaValue">${data.pp_orange_tp}</div> <g:message code="panel.percent"/></td>
                </tr>

                <tr>
                    <td><g:message code="panel.plus"/></td><td><g:message code="panel.polkomtel.company"/></td>
                    <td> <div class="telekodzikValue">${data.pp_plus_tk}</div> <g:message code="panel.percent"/></td>
                    <td><div class="telepompkaValue">${data.pp_plus_tp}</div> <g:message code="panel.percent"/></td>
                </tr>

                <tr>
                    <td><g:message code="panel.tmobile"/></td>
                    <td><g:message code="panel.ptc.company"/></td>
                    <td> <div class="telekodzikValue">${data.pp_tmobile_tk}</div> <g:message code="panel.percent"/></td>
                    <td><div class="telepompkaValue">${data.pp_tmobile_tp}</div> <g:message code="panel.percent"/></td>
                </tr>

                <tr>
                    <td><g:message code="panel.heyah"/></td>
                    <td><g:message code="panel.ptc.company"/></td>
                    <td> <div class="telekodzikValue">${data.pp_heyah_tk}</div> <g:message code="panel.percent"/></td>
                    <td><div class="telepompkaValue">${data.pp_heyah_tp}</div> <g:message code="panel.percent"/></td>
                </tr>

                <tr>
                    <td><g:message code="panel.play"/></td><td><g:message code="panel.p4.company"/></td>
                    <td><div class="telekodzikValue">${data.pp_play_tk}</div> <g:message code="panel.percent"/></td>
                    <td><div class="telepompkaValue">${data.pp_play_tp}</div> <g:message code="panel.percent"/></td>
                </tr>

                <tr>
                    <td><g:message code="panel.telegrosik"/></td><td><g:message code="panel.galena.company"/></td>
                    <td><div class="telekodzikValue">${data.pp_telegrosik_tk}</div> <g:message code="panel.percent"/></td>
                    <td></td>
                </tr>

                <tr>
                    <td><g:message code="panel.virginmobile"/></td>
                    <td><g:message code="panel.virginmobile.company"/></td>
                    <td><div class="telekodzikValue">${data.pp_virginmobile_tk}</div> <g:message code="panel.percent"/></td>
                    <td></td>
                </tr>

                <tr>
                    <td><g:message code="panel.lycamobile"/></td>
                    <td><g:message code="panel.lycamobile.company"/></td>
                    <td><div class="telekodzikValue">${data.pp_lycamobile_tk}</div> <g:message code="panel.percent"/></td>
                    <td></td>
                </tr>
                </tbody>
            </table>
