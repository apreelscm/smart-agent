<div class="subpanel">
	...
	<div>
		<label for="additionalequipment-sameForEveryPoint"><g:checkBox name="additionalequipment-sameForEveryPoint" /><g:message code="panel.sameforeverypoint" /></label>
		<table class="vertical-center" >
			<tbody>
				...
				<tr><td><g:message code="panel.newpoint.additionalequipment.other" /> <g:textField name="otherAdditionalDevice" style="width: 150px;" /> <label for="otherAdditionalDeviceSsl"><g:checkBox name="otherAdditionalDeviceSsl" /><g:message code="panel.ssl" /></label> <label for="otherAdditionalDeviceGprs"><g:checkBox name="otherAdditionalDeviceGprs" /><g:message code="panel.gprs" /></label></td><td>typ <select name="otherAdditionalDeviceType" style="width: 50px"></select></td><td><g:textField name="otherAdditionalDeviceCount" style="width: 50px"/> szt.</td><td><g:textField name="otherAdditionalDevicePrice" style="width: 50px"/> <g:message code="panel.price" /></td></tr>
			</tbody>
		</table>
	</div>
</div>