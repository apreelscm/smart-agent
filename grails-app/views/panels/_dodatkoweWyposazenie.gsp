<fieldset class="subpanel-fieldset">
	...
	<div class="subpanel-fieldset-centercontent" >
		...
		<table class="vertical-center" >
			<tbody>
				<tr><td><g:message code="panel.newpoint.additionalequipment.pinpad" /></td><td>typ <select style="width: 50px"></select></td><td><g:textField name="pinPadCount%ID%" style="width: 50px"/> szt.</td><td><g:textField name="pinPadPrice%ID%" style="width: 50px"/> <g:message code="panel.price" /></td></tr>
				<tr><td><g:message code="panel.newpoint.additionalequipment.router" /></td><td>typ <select style="width: 50px"></select></td><td><g:textField name="routerCount%ID%" style="width: 50px"/> szt.</td><td><g:textField name="routerPrice%ID%" style="width: 50px"/> <g:message code="panel.price" /></td></tr>
				<tr><td><g:message code="panel.newpoint.additionalequipment.cardreader" /></td><td>typ <select style="width: 50px"></select></td><td><g:textField name="cardReaderCount%ID%" style="width: 50px"/> szt.</td><td><g:textField name="cardReaderPrice%ID%" style="width: 50px"/> <g:message code="panel.price" /></td></tr>
