		...
		<ul class="table-list">
		  	<li>
		  		...
		  		<span>
                   ...
                   <g:textField name="%ID%contactAddressAddressStreet" style="width: 200px"/>
                </span>
                <span>
                	<span><g:message code="panel.house.number" /></span> <span><g:textField name="%ID%contactAddressAddressHomeNumber" style="width: 50px"/></span>
                	<span><g:message code="panel.flat.number" /></span> <span><g:textField name="%ID%contactAddressAddressFlatNumber" style="width: 50px"/></span>
                </span>
            </li>
		  	<li>
		  		<span><g:message code="panel.city" /></span>
		  		<span><g:textField name="%ID%contactAddressAddressCity" style="width: 280px;"/></span>
		  		<span>
		  			<span><g:message code="panel.postal.code" /></span> <span><g:textField name="%ID%contactAddressAddressPostalCode" style="width: 50px"/></span>
		  		</span>
		  	</li>
		  	<li>
		  		<span><g:message code="panel.postal" /></span>
		  		<span><g:textField name="%ID%contactAddressAddressPostOffice" style="width: 280px;"/></span>
		  	</li>
	  	</ul>
	</div>
</fieldset>