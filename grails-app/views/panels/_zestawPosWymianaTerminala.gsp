                ...
                <g:each status="i" var="pe" in="${data.posExchanges}">
                    <tr>
                        ...
                        <g:if test="${pe.newType}">
                            <td class="align-center"><dict:typeSelect class="selectModel" medium="${pe.newType}" data-index="${i}" id="selectModel_${i}" name="posExchanges[${i}].newModel" from="[]" valueMessagePrefix="" value="${pe.newModel}" style="width: 120px" /></td>
                        </g:if>
                        <g:else>
