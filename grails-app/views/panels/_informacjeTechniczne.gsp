<fieldset class="subpanel-fieldset">
	...
	<div class="subpanel-fieldset-centercontent" >
		...
		<p><g:message code="panel.from" /> <g:textField name="${panelType}[${id}].zamkniecieDniaOd" style="width: 140px;" id="${panelType}[${id}].dayCloseFrom" value="${pointData?.zamkniecieDniaOd}"/> <g:message code="panel.to" /> <g:textField name="${panelType}[${id}].zamkniecieDniaDo" style="width: 140px;" id="${panelType}[${id}].dayCloseTo" value="${pointData?.zamkniecieDniaDo}"/> <g:message code="panel.newpoint.technicalinformation.plannedinstallationdate" /> <g:textField name="${panelType}[${id}].planowanaDataInstalacji" style="width: 140px;" id="${panelType}[${id}].plannedInstallationDate" value="${pointData?.planowanaDataInstalacji}"/></p>
		<p><g:message code="panel.additionalnotes" /></p>
		<p><g:textField name="${panelType}[${id}].uwagiDodatkowe" id="${panelType}[${id}].additionalNotes" value="${pointData?.uwagiDodatkowe}"/></p>
	</div>
</fieldset>