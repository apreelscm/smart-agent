	...
	<div class="subpanel-fieldset-centercontent" >
		...
		<ul class="table-list vertical-center">
			<li>
				...
				<span><g:message code="panel.first.name" />:</span><span><eumowy:textField name="${panelType}[${id}].kontaktWPunkcieImie" id="${panelType}[${id}].contactAtPointFirstName" value="${pointData?.kontaktWPunkcieImie}" style="width: 120px" maxlength="15"/></span>
				<span><g:message code="panel.last.name" />:</span><span><eumowy:textField name="${panelType}[${id}].kontaktWPunkcieNazwisko" id="${panelType}[${id}].contactAtPointLastName" value="${pointData?.kontaktWPunkcieNazwisko}"  style="width: 120px" maxlength="18"/></span>
