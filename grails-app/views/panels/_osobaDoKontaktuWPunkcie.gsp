<fieldset class="subpanel-fieldset">
	...
	<div class="subpanel-fieldset-centercontent" >
		...
		<ul class="table-list vertical-center">
			<li>
				<span><g:select name="${panelType}[${id}].kontaktWPunkcieTytul" id="${panelType}[${id}].contactAtPointTitle" from="['', 'Pan','Pani']" valueMessagePrefix="person.title" value="${pointData?.tytulInformatykDynamiczna}" /></span>
			...
			<li>
				<span></span>
				<span><g:message code="panel.landline.phone.number" />:</span><span><g:textField class="phone" name="${panelType}[${id}].kontaktWPunkcieTelStacjonarny" id="${panelType}[${id}].contactAtPointPhone" value="${pointData?.kontaktWPunkcieTelStacjonarny}" style="width: 120px" maxlength="9"/></span>
				<span><g:message code="panel.mobile.phone.number" />:</span><span><g:textField class="mobile-phone" name="${panelType}[${id}].kontaktWPunkcieTelKomorkowy" id="${panelType}[${id}].contactAtPointMobilePhone" value="${pointData?.kontaktWPunkcieTelKomorkowy}" style="width: 120px" maxlength="9"/></span>
