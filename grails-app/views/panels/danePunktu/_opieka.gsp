    ...
    <div class="subpanel-fieldset-centercontent" >
	    <ul class="table-list vertical-center">
	        <li>
                ...
                <span><g:textField style="width: 45px;" name="${panelType}[${id}].opiekaSerwisowaIII" id="${panelType}[${id}].serviceCare3" value="${pointData?.opiekaSerwisowaIII}" maxlength="5" readonly="readonly"/></span>
	        </li>
	    </ul>
    </div>
</fieldset>