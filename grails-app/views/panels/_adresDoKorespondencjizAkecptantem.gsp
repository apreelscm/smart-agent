    ...
    <fieldset>
        ...
        <div style="text-align: center; padding-top: 20px; width: 750px" class="centre">
            <ul class="table-list centre">
                <li>
                    <span style="float: left"><label for="correspondenceAsMerchant"><g:checkBox id="correspondenceAsMerchant" name="korespondencjaJakDlaMerchanta" value="${data.korespondencjaJakDlaMerchanta}" /><g:message code="panel.as.merchant"/></label></span>
                </li>
                <li>
                    <span>
                        ...
                        <span>
                            ...
                            <span><eumowy:textField name="akceptantKontaktNrDomu" value="${data.akceptantKontaktNrDomu}" validatable="${data}" style="width: 50px" maxlength ="6" required="true"/></span>
                            <span><g:message code="panel.flat.number" /></span>
                            <span><eumowy:textField name="akceptantKontaktNrMieszkania" value="${data.akceptantKontaktNrMieszkania}" validatable="${data}" style="width: 50px" maxlength ="4"/></span>
                        </span>
                    </span>
                </li>
                ...
                <li>
                    <span>
                        ...
                        <span><eumowy:textField class="postal-code" id="akceptantKontaktKodPocztowy" name="akceptantKontaktKodPocztowy" value="${data.akceptantKontaktKodPocztowy}" validatable="${data}" style="width: 50px" maxlength ="5" required="true"/></span>
