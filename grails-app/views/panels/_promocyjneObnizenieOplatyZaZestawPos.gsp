				...
				<tbody>
					<g:each status="i" var="pos" in="${data.allPoses}" >
                        <tr>
                            ...
                            <td><eumowy:textField name="allPoses[${i}].dataOd" value="${g.formatDate( format:"yyyy-MM-dd", date:pos.dataOd)}" validatable="${pos}" validateField="dataOd" style="width: 120px"/></td>
