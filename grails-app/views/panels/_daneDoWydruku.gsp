    ...
    <fieldset style="text-align: center">
        ...
        <div style="text-align: center; padding-top: 20px; width: 750px" class="centre">
            <div class="align-left">
                ...
                <p><eumowy:textField name="nazwaDoWydrukuZTerminalaPos" value="${data.nazwaDoWydrukuZTerminalaPos}" validatable="${data}" maxlength ="25" required="true" class="nazwaField"/></p>
