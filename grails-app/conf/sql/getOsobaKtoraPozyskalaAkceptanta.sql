select prz_imie as imie, prz_nazwisko as nazwisko, prz_numer_sprzedazowy as nr from CBD_ADM.cbt_klienci m
join CBD_ADM.cbt_przedstawicieleh a on a.prz_id=m.kln_prz_id_pozyskany_przez
