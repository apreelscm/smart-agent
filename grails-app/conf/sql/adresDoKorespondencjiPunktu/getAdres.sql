SELECT a.adr_ulica as ulica, a.adr_nr_lokal as nr_lokal, a.adr_nr_budynku as nr_budynku, a.adr_miejscowosc as miejscowosc, a.adr_kod_pocztowy as kod_pocztowy, a.adr_miejscowosc as poczta from cbt_adresy a
