SELECT VALUE FROM (SELECT RV_LOW_VALUE VALUE,RV_MEANING   MEANING FROM CG_REF_CODES WHERE RV_DOMAIN = 'LW_TYP_ULICY') i domyślna wartość SELECT a.adr_typ_ulicy from cbt_adresy a
