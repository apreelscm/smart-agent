...
class RepresentativeService {
    ...
    List<RepresentativeCommand> getRepresentativesFromCBD(String nip) {
        ...
        return representatives.collect { result ->
            ...
            representative.setStreet(result.ulica)
            representative.setStreetTitle(result.ulicaTyp)
            representative.setCountry(result.kraj)
            representative.setHouseNumber(result.numerDomu)
            representative.setFlatNumber(result.numerLokalu)
            representative.setPostalCode(result.kodPocztowy)
            representative.setCity(result.miasto)
            representative.setPostOffice(result.poczta)
