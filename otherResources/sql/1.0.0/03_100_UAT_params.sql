insert into EUMOWY.APP_PARAMETERS (id, name, value) values (0, 'TEMP_PDFIMAGE_STORAGE_PATH', 'files/pdf_images/');
insert into EUMOWY.APP_PARAMETERS (id, name, value) values (1, 'TEMP_PDFIMAGE_STORAGE_URI', '/eumowy/files/pdf_images/'); -- FIXME
insert into EUMOWY.APP_PARAMETERS (id, name, value) values (2, 'PDF_TEMPLATE_PATH', '/opt/eumowy/pdf_templates/'); -- TODO (czemu nie URI ?)
insert into EUMOWY.APP_PARAMETERS (id, name, value) values (3, 'SUBSCRIPTIONS_PATH', 'files/');
insert into EUMOWY.APP_PARAMETERS (id, name, value) values (4, 'SUBSCRIPTIONS_PATH_BLACKPREFIX', 'black_');
insert into EUMOWY.APP_PARAMETERS (id, name, value) values (5, 'TEMPLATE_NAME_FOR_NEW_POINT', null);
insert into EUMOWY.APP_PARAMETERS (id, name, value) values (6, 'TEMPLATE_NAME_FOR_NEW_POS', null);
...
insert into EUMOWY.APP_PARAMETERS (id, name, value) values (11, 'FONT_URI', '/eumowy/fonts');  -- FIXME
insert into EUMOWY.APP_PARAMETERS (id, name, value) values (12, 'TEMP_PDFPREVIEW_STORAGE_PATH', 'tmp');
