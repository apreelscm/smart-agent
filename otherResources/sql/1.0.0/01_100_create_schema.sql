...
create table EUMOWY.POINT_DETAILS (id number(19,0) not null, version number(19,0) not null, contact_addr_streettype varchar2(255 char) not null, mcc_code varchar2(255 char) not null, contact_at_point_email varchar2(255 char) not null, contact_at_point_fax varchar2(255 char) not null, contact_at_point_firstname varchar2(255 char) not null, contact_at_point_lastname varchar2(255 char) not null, contact_at_point_mobilephone varchar2(255 char) not null, contact_at_point_phone varchar2(255 char) not null, bank_account_number varchar2(255 char) not null, contact_addr_postalcode varchar2(255 char) not null, contact_addr_home_number number(10,0) not null, contact_addr_flat_number number(10,0) not null, contact_addr_post_office varchar2(255 char) not null, contact_addr_street varchar2(255 char) not null, contact_addr_city varchar2(255 char) not null, bank_name varchar2(255 char) not null, name_print_posterminal varchar2(255 char) not null, name_search_engine varchar2(255 char) not null, nip varchar2(255 char) not null, business_care number(19,2) not null, service_care1 number(19,2) not null, service_care2 number(19,2) not null, service_care3 number(19,2) not null, ph_gain number(19,2) not null, point_id number(19,0) not null unique, bussiness_type_in_practice varchar2(255 char) not null, print_addr_postal_code varchar2(255 char) not null, print_otherdata_terminal1 varchar2(255 char) not null, print_otherdata_terminal2 varchar2(255 char) not null, print_addr_city varchar2(255 char) not null, print_addr_home_number number(10,0) not null, print_addr_flat_number number(10,0) not null, print_addr_post_office varchar2(255 char) not null, print_addr_street varchar2(255 char) not null, print_addressstreet_type varchar2(255 char) not null, primary key (id));
