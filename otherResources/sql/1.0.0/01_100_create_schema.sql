...
create table EUMOWY.POS (id number(19,0) not null, version number(19,0) not null, is_selected number(1,0), date_to timestamp, date_from timestamp, pos_set_number number(10,0), point_id number(19,0), tps_id number(10,0), price_count number(19,2), pos_datas_idx number(10,0), primary key (id));
create table EUMOWY.POS_DETAILS (id number(19,0) not null, version number(19,0) not null, statdevice_ip varchar2(255 char), set_analysis number(1,0), base_count number(10,0), noreturnfunction number(1,0), statdevice_gateway varchar2(255 char), card_reader_price number(19,2), card_reader_count number(10,0), card_reader_type varchar2(255 char), dialup_price number(19,2), dialup_count number(10,0), dialup_pp_price number(19,2), dialup_pp_count number(10,0), dialup_type varchar2(255 char), gprs_price number(19,2), gprs_count number(10,0), gprs_pp_price number(19,2), gprs_pp_count number(10,0), gprs_type varchar2(255 char), dynamicdevicesupp_name varchar2(255 char), statdevicesupp_contactname varchar2(255 char), other_additional_device varchar2(255 char), otheradditionaldevice_price number(19,2), otheradditionaldevice_gprs number(1,0), otheradditionaldevice_count number(10,0), otheradditionaldevice_ssl number(1,0), otheradditionaldevice_type varchar2(255 char), cashmachine_systemintegration number(1,0), gift_card number(1,0), dynamicdevicesupp_contact varchar2(255 char), statdevicesupp_contact varchar2(255 char), log_beforeeverytransaction number(1,0), log_everychange number(1,0), statdevice_mask varchar2(255 char), tip1 number(1,0), dynamicdevicesupp_surname varchar2(255 char), statdevicesupp_contactsurname varchar2(255 char), pin_pad_price number(19,2), pin_pad_count number(10,0), pin_pad_type varchar2(255 char), planned_installation_date timestamp, pos_id number(19,0) not null unique, preauthorization number(1,0), router_price number(19,2), router_count number(10,0), router_type varchar2(255 char), ssl_price number(19,2), ssl_count number(10,0), ssl_pp_price number(19,2), ssl_pp_count number(10,0), ssl_type varchar2(255 char), tele_kodzik number(1,0), tele_pompka number(1,0), dynamicdevicesupp_title varchar2(255 char) not null, statdevicesupp_title varchar2(255 char) not null, additional_notes varchar2(255 char), vpn_price number(19,2), vpn_count number(10,0), vpn_pp_price number(19,2), vpn_pp_count number(10,0), vpn_type varchar2(255 char), wifi_price number(19,2), wifi_count number(10,0), wifi_pp_price number(19,2), wifi_pp_count number(10,0), wifi_type varchar2(255 char), day_close_to varchar2(255 char), day_close_from varchar2(255 char), return_with_password number(1,0), returnIKO number(1,0), primary key (id));
