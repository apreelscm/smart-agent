...
-- INDEXES
CREATE INDEX ACTIVITY_SIGN_ACTIVITY_ID_IDX ON EUMOWY.ACTIVITY_SIGNATURES(activity_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX ACTIVITY_SIGN_SIGNATURE_ID_IDX ON EUMOWY.ACTIVITY_SIGNATURES(signature_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX ATTACHMENT_PROCESS_ID_IDX ON EUMOWY.ATTACHMENT(process_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX CALCF_SIG_CALC_FIELD_ID_IDX ON EUMOWY.CALCFIELD_SIGNATURE(calc_field_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX CALCF_SIG_SIGNATURE_ID_IDX ON EUMOWY.CALCFIELD_SIGNATURE(signature_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX CLIENT_NIP_IDX ON EUMOWY.CLIENT(nip) TABLESPACE EUMOWY_INDX;
CREATE INDEX DOCUMENT_SIGNATURE_ID_IDX ON EUMOWY.DOCUMENT(signature_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX DOCUMENT_PROCESS_ID_IDX ON EUMOWY.DOCUMENT(process_id) TABLESPACE EUMOWY_INDX;
--CREATE INDEX DOCUMENT_CONTENT_DOC_ID_IDX ON EUMOWY.DOCUMENT_CONTENT(document_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX POINT_PROCESS_ID_IDX ON EUMOWY.POINT(process_id) TABLESPACE EUMOWY_INDX;
--CREATE INDEX POINT_DETAILS_POINT_ID_IDX ON EUMOWY.POINT_DETAILS(point_id) TABLESPACE EUMOWY_INDX;
--CREATE INDEX POS_POINT_ID_IDX ON EUMOWY.POS(point_id) TABLESPACE EUMOWY_INDX;
--CREATE INDEX POS_DETAILS_POS_ID_IDX ON EUMOWY.POS_DETAILS(pos_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX PROCESS_CLIENT_ID_IDX ON EUMOWY.PROCESS(client_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX PROCESS_DATA_PROCESS_ID_IDX ON EUMOWY.PROCESS_DATA(process_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX SIGNATURE_PANEL_PANEL_ID_IDX ON EUMOWY.SIGNATURE_PANEL(panel_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX SIGNATURE_PANEL_SIGN_ID_IDX ON EUMOWY.SIGNATURE_PANEL(signature_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX PROCESS_ACTIVITY_ACTIV_ID_IDX ON EUMOWY.PROCESS_ACTIVITY(activity_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX PROCESS_ACTIVITY_PR_ACT_ID_IDX ON EUMOWY.PROCESS_ACTIVITY(process_activities_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX PROCESS_SIGNATURE_SIGN_ID_IDX ON EUMOWY.PROCESS_SIGNATURE(signature_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX PROCESS_SIGN_PR_SIG_ID_IDX ON EUMOWY.PROCESS_SIGNATURE(process_signatures_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX PROCESS_SUBSCR_SUB_ID_IDX ON EUMOWY.PROCESS_SUBSCRIPTION(subscription_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX PROCESS_SUBSCR_PR_SUB_ID_IDX ON EUMOWY.PROCESS_SUBSCRIPTION(process_subscriptions_id) TABLESPACE EUMOWY_INDX;
CREATE INDEX PROCESS_PANEL_PANEL_ID_IDX ON EUMOWY.PROCESS_PANEL(PANEL_ID) TABLESPACE EUMOWY_INDX;
CREATE INDEX SUBSCRIPTION_DEF_SIGN_ID_IDX ON EUMOWY.SUBSCRIPTION_DEFINITION(signature_id) TABLESPACE EUMOWY_INDX;
