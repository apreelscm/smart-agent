...
export type BirthInputMode = 'dateOfBirth' | 'pesel';
...
export function emptyDraft(): PolicyDraft {
  return {
    ...
    coverages: {
      ...
      bagaz: false, opony: false, promoCode: '', totalPremium: 989,
    },
...
export function seedDraft(): PolicyDraft {
  ...
  return {
    ...
    coverages: {
      ...
      szyby: true,
      szybyDetails: { partsType: 'alternatywne', noDeductibleFirst: true, deductibleNext: true, sumInsured: 10000 },
      bagaz: false, opony: false, promoCode: '', totalPremium: 1057,
    },
    policyholder: { ...person },
    insured: { ...person },
    coOwner: null,
