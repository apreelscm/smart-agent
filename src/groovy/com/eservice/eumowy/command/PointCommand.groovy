...
class PointCommand implements Serializable {
	...
	static constraints = {
		...
		numerRachunkuBankowego(nullable:true, blank:false, shared: "natural")
		bank(nullable:true, blank:false, shared: "alpha")
		...
		wydrukKodPocztowy(nullable:true, blank:false, shared: "natural")
		...
		kontaktWPunkcieTelStacjonarny(nullable:true, blank:false, shared: "natural")
		kontaktWPunkcieTelKomorkowy(nullable:true, blank:false, shared: "natural")
...
//		})
		...
		uwagiDodatkowe(nullable:true, blank:false, shared: "alpha")
		...
		kontaktInformatykStatyczna(nullable:true, blank:false, shared: "natural")
		...
		kontaktInformatykDynamiczna(nullable:true, blank:false, shared: "natural")
