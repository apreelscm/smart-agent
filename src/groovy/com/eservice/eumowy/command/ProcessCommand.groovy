...
//    uwagi
    ...
    static constraints = {
        ...
        akceptantKontaktUlica(nullable:true, shared: "alpha")
        akceptantKontaktNrDomu(nullable:true, shared: "alpha")
        akceptantKontaktNrMieszkania(nullable:true, shared: "natural")
        akceptantKontaktMiasto(nullable:true, shared: "alpha")
        akceptantKontaktKodPocztowy(nullable:true)
        akceptantKontaktPoczta(nullable:true, shared: "alpha") 
   ...
   /*   akceptantNazwaOficjalna(nullable:false, blank:false) //a1!, M
        ...
        wydrukUlica(nullable:true, shared: "alpha")
        wydrukNrDomu(nullable:true, shared: "alpha")
        wydrukNrMieszkania(nullable:true, shared: "natural")
        wydrukMiasto(nullable:true, shared: "alpha")
        wydrukKodPocztowy(nullable:true)
        wydrukPoczta(nullable:true, shared: "alpha")
 ...
 /*     wydrukGrafikiCena(nullable:true, shared: "number")
        ...
        srednia_sprzedaz_doladowan_slownie(nullable:true, shared:"lettersonly")
 ...
 /*     okresLojalnosciowy(nullable:true)
        ...
        kontaktImie(nullable:true, shared:"lettersonly")
        kontaktNazwisko(nullable:true, shared:"lettersonly")
    ...
    /*  pozyskujacyTytul(nullable:true)
        pozyskujacyImie(nullable:true, shared:"lettersonly")
        pozyskujacyNazwisko(nullable:true, shared:"lettersonly")
        pozyskujacyNumer(nullable:true) */
        reprezentant1Tytul(nullable:true)
        reprezentant1Imie(nullable:true, shared:"lettersonly")
        reprezentant1Nazwisko(nullable:true, shared:"lettersonly")
 ...
 /*     akceptantUlicaTytul(nullable:true)
        akceptantUlica(nullable:true, shared:"alpha")
        akceptantNrDomu(nullable:true, shared: "alpha")
        akceptantNrMieszkania(nullable:true, shared: "alpha")
        akceptantMiasto(nullable:true, shared: "alpha")
        akceptantKodPocztowy(nullable:true)
        akceptantPoczta(nullable:true, shared: "alpha")
     ...
     akceptantFax(nullable:true, blank:true)
        ...
        miejsceUmowy(nullable:true, shared: "alpha")
    ...
    //  obslugaTyp(nullable:true)
        ...
        bankKlienta(nullable:true, shared:"alpha")
