...
//    uwagi
    ...
    static constraints = {
        ...
        oplataVISAPr(nullable:true, shared: "number")
        oplataMasterCard(nullable:true, shared: "number")
        oplataMasterCardPr(nullable:true, shared: "number")
        oplataMaestro(nullable:true, shared: "number")
        oplataMasteroPr(nullable:true, shared: "number")
        ...
        ifOplataVISA(nullable:true, shared: "number") //1.11 %, M
        ifOplataMasterCard(nullable:true, shared: "number") //1.11 %, M
        ifOplataDinersClub(nullable:true, shared: "number") //1.11 %, M
        ifOplataIKO(nullable:true, shared: "number") //1.11 %, M
        ifOplataPKOPB(nullable:true, shared: "number") //1.11 %, M
