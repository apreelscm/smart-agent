...
//END REFACTORING
        ...
        obslugaEkonomicznyCena(nullable:true, blank:false,  validator: { value, cmd, errors -> cmd.numberValidationClosure(value, cmd, errors, "obslugaEkonomicznyCena")}) //TODO VERIFY Mariusz ustawil xxx nie wiedziec czemu
