...
//    uwagi
    ...
    static constraints = {
        ...
        akceptantFax()
        akceptantFaxCbd()
        akceptantKodPocztowy()
        akceptantKodPocztowyCbd()
        akceptantKontaktKodPocztowy()
        akceptantKontaktMiasto()
        akceptantKontaktNrDomu()
        akceptantKontaktNrMieszkania()
        akceptantKontaktPoczta()
        akceptantKontaktUlica()
        akceptantMiasto()
        akceptantMiastoCbd()
        akceptantNazwaOficjalna()
        akceptantNazwaOficjalnaCbd()
        akceptantNazwaSieciowa()
        akceptantNazwaSieciowaCbd()
        akceptantNrDomu()
        akceptantNrDomuCbd()
        akceptantNrMieszkania()
        akceptantNrMieszkaniaCbd()
        akceptantPoczta()
        akceptantPocztaCbd()
        akceptantRegon()
        akceptantRegonCbd()
        akceptantTelKomorkowy()
        akceptantTelKomorkowyCbd()
        akceptantTelStacjonarny()
        akceptantTelStacjonarnyCbd()
        akceptantUlica()
        akceptantUlicaCbd()
        akceptantUlicaTytulCbd()
        dataAneksowanejUmowyPos()
        dzialalnoscDokumentInny()
        dzialalnoscForma()
        dzialalnoscFormaInna()
        dzialaniaMatematyczneCena()
        ifOplataDinersClub()
        ifOplataIKO()
        ifOplataMasterCard()
        ifOplataPKOPB()
        ...
        kontaktNazwisko()
        kontaktTelKomorkowy()
        kontaktTelStacjonarny()
        kontaktTytul()
        obslugaEkonomicznyCena()
        obslugaTyp()
        oplPOSDialUpIlosc()
        oplPOSDialUpIloscPP()
        oplPOSDialUpNormalneMies()
        oplPOSDialUpNormalnePP()
        oplPOSDialUpPreferencyjneMies()
        oplPOSDialUpPreferencyjnePP()
        oplPOSGPRSIlosc()
        oplPOSGPRSIloscPP()
        oplPOSGPRSNormalneMies()
        oplPOSGPRSNormalnePP()
        oplPOSGPRSPreferencyjneMies()
        oplPOSGPRSPreferencyjnePP()
        oplPOSSSLIlosc()
        oplPOSSSLIloscPP()
        oplPOSSSLNormalneMies()
        oplPOSSSLNormalnePP()
        oplPOSSSLPreferencyjneMies()
        oplPOSSSLPreferencyjnePP()
        oplPOSVPNIlosc()
        oplPOSVPNIloscPP()
        oplPOSVPNNormalneMies()
        oplPOSVPNNormalnePP()
        oplPOSVPNPreferencyjneMies()
        oplPOSVPNPreferencyjnePP()
        oplPOSWiFiIlosc()
        oplPOSWiFiIloscPP()
        oplPOSWiFiNormalneMies()
        oplPOSWiFiNormalnePP()
        oplPOSWiFiPreferencyjneMies()
        oplPOSWiFiPreferencyjnePP()
        pierwszaSesjaCena()
        pozyskujacyImie()
        pozyskujacyNazwisko()
        pozyskujacyNumer()
        pozyskujacyTytul()
        reprezentant1Imie()
        reprezentant1Nazwisko()
        reprezentant1Tytul()
        reprezentant2Imie()
        reprezentant2Nazwisko()
        reprezentant2Tytul()
        rodzajZezwolenia()
        scoringAkceptacja()
        scoringCharakterystyka()
        scoringCharakterystykaInna()
        scoringCzestoscTransakcji()
        scoringDeklaracjaFinansowa()
        scoringDeklaracjaFinansowaObrotNaKarty()
        scoringDeklaracjaFinansowaObrotOgolem()
        scoringDeklaracjaFinansowaSredniObrot()
        scoringDeklaracjaFinansowaSredniaTransakcja()
        scoringDochodowosc()
        scoringDzialalnosc()
        scoringDzialalnoscCzas()
        scoringIloscTransakcji()
        scoringKoncesja()
        scoringLokalizacjaPunktu()
        scoringMcc()
        scoringMonitoring()
        scoringOtwartyZamkniety()
        scoringRuchTurystycznyPrzygraniczny()
        scoringSprzedazTowarowEkskluzywnych()
        scoringStanZadbany()
        scoringSzczegolyDzialalnosci()
        scoringTypPunktu()
        scoringWielkoscMiejscowosci()
        scoringWielkoscPunktu()
        scoringWlasnosc()
        tytulPlatnosciCena()
        umowaCzas()
        umowaOznDo()
