...
//    uwagi
    ...
    static constraints = {
        ...
        akceptantKontaktUlica(nullable:false, blank:false)
        akceptantKontaktNrDomu(nullable:false, blank:false)
        akceptantKontaktNrMieszkania(nullable:false, blank:false)
    ...
    /*    dataAneksowanejUmowyPos(nullable:false, blank:false, shared: "date")
        ...
        wydrukUlica(nullable:false, blank:false)
        wydrukNrDomu(nullable:false, blank:false)
        wydrukNrMieszkania(nullable:false, blank:false)
        wydrukMiasto(nullable:false, blank:false)
...
/*        ifOplataVISA(nullable:false, blank:false, shared: "number") //1.11 %, M
        ...
        pozyskujacyNazwisko(nullable:false, blank:false)
        pozyskujacyNumer(nullable:false, blank:false)
        reprezentant1Tytul(nullable:false, blank:false)
        reprezentant1Imie(nullable:false, blank:false)
        reprezentant1Nazwisko(nullable:false, blank:false)
...
/*        visaEUKKOPr(nullable:false, blank:false, shared: "percentage")
      ...
      /*  pp_orange_tk(nullable:false, blank:false, shared: "percentage")
        ...
        akceptantUlica(nullable:false, blank:false)
        akceptantNrDomu(nullable:false, blank:false)
        akceptantNrMieszkania(nullable:false, blank:false)
