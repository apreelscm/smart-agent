...
//    uwagi
    ...
    static constraints = {
        ...
        dataAneksowanejUmowyPrepaid(nullable:true)
        umowaCzas(nullable:true)
        umowaOznOd(nullable:true)
        umowaOznDo(nullable:true)
        akceptantNazwaOficjalna(nullable:false) //a1!, M
        ...
        oplataVISA(nullable:true)
        oplataVISAPr(nullable:true)
        oplataMasterCard(nullable:true)
        oplataMasterCardPr(nullable:true)
        oplataMaestro(nullable:true)
        ...
        pp_orange_tk(nullable:true)
        pp_orange_tp(nullable:true)
        pp_plus_tk(nullable:true)
        pp_plus_tp(nullable:true)
        pp_tmobile_tk(nullable:true)
        pp_tmobile_tp(nullable:true)
        pp_heyah_tk(nullable:true)
        pp_heyah_tp(nullable:true)
        pp_play_tk(nullable:true)
        pp_play_tp(nullable:true)
        pp_telegrosik_tk(nullable:true)
        pp_virginmobile_tk(nullable:true)
        pp_lycamobile_tk(nullable:true)
        pp_gtmobile_tk(nullable:true)
        pp_vectonemobile_tk(nullable:true)
        pp_delightmobile_tk(nullable:true)
        oplataZaOprogramowanieDoDoladowan(nullable:true)
        ...
        scoringTypPunktuInny(nullable:true)
        ...
        numerRachunkuBankowegoKlienta(nullable:true)
        bankKlienta(nullable:true)
        oplataZaUruchomienieDCC(nullable:true)
        nip(nullable:true)
