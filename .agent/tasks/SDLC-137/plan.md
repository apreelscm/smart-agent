...
- W kodzie produkcyjnym **nie należy dodawać mockowego runtime fallbacku**. Mockowanie pozostaje wyłącznie w testach (`HttpTestingController`, Playwright route mocking).
...
| 3.2 | Dopracować scenariusze Playwright | `tests/e2e/login.spec.ts` | Pokryć redirect z `/`, ochronę tras, skuteczne logowanie `admin/admin`, walidację pustych pól i błąd niepoprawnych danych. |
